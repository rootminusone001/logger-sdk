...
/**
 * Creates a shared axios client for backend transport requests with keep-alive pooling and retries.
 */
export function createHttpClient(baseUrl: string, retryOptions: RetryOptions = {}) {
